...
const Courseprice = () => {
  return (
    <>
      <div className=" w-9/12 m-auto mb-8 xs:hidden">
        {/* navheader */}
        <div className="flex justify-between ">
          ...
          <div className="flex gap-5 mt-4 items-center">
            ...
            <button className="px-8 h-12 rounded-lg text-lg font-normal text-primary">
            <span> <Link to="/signin"> Log Out</Link> </span>
            </button>
          </div>
        </div>
        ...
        <Button />
                      ...
                      <div className="hidden xs:block w-11/12 m-auto mb-8 ">
        {/* navheader */}
        <div className="flex justify-between ">
          <div>
            <img className="xs:h-16" style={{width: "6em"}} src={Logo} alt="" />
          </div>
          ...
          <div className="base rounded-lg">
            ...
            <div className="">
              <div className="flex justify-between w-10/12 mx-auto h-30 py-4">
                ...
                <div className="text-white font-medium"><span>$ 200.00</span></div>
              </div>
            </div>
